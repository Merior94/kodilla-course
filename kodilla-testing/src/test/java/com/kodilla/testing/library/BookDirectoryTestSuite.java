...
class BookDirectoryTestSuite {
    ...
    void testListBooksWithConditionFragmentShorterThan3() {                          // [1]
        // Given
        //LibraryDatabase libraryDatabaseMock = mock(LibraryDatabase.class);            // [2] - niepotrzebna instancja
        BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);               // [3]
    ...
    void testListBooksInHandsOfNone() {
        ...
        LibraryUser libraryUser0 = new LibraryUser("Jan0","Kowalski", "123456789");
        LibraryUser libraryUser1 = new LibraryUser("Jan1","Kowalski", "123456789");
        LibraryUser libraryUser5 = new LibraryUser("Jan5","Kowalski", "123456789");
