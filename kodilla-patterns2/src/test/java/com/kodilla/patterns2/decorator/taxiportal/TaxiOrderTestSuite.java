...
class TaxiOrderTestSuite {                               // [5]
    ...
    public void testVipTaxiWithChildSeatExpressGetCost() {
        //Given
        TaxiOrder theOrder = new BasicTaxiOrder();  //5
        theOrder = new TaxiNetworkOrderDecorator(theOrder); //35
        theOrder = new ExpressDecorator(theOrder);  //5
        theOrder = new VipCarDecorator(theOrder);   //10
        theOrder = new ChildSeatDecorator(theOrder);    //2
